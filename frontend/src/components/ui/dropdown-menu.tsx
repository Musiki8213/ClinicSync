...
>(({ className, style, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal container={getPortalContainer()}>
    <DropdownMenuPrimitive.SubContent
      ref={ref}
      className={cn(floatingMenuSurface, 'min-w-[8rem] overflow-hidden p-1', className)}
      style={{ ...style }}
      {...props}
    />
...
>(({ className, side = 'bottom', sideOffset = 4, align = 'start', avoidCollisions = false, style, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal container={getPortalContainer()}>
